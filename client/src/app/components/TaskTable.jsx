const filterList = ["Todas", "Finalizadas", "Pendientes", "Vencidas"];

function TaskTable() {
  return (
    <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 rounded-md">
      {/*HeaderTable*/}
      <div className="sm:flex items-center justify-between">
        <div className="flex items-center">
          {filterList.map((filter, index) => (
            <div
              className="py-2 px-8 text-gray-600 hover:text-indigo-700 hover:bg-indigo-100 rounded-full focus:outline-none focus:ring-2 focus:bg-indigo-50 focus:ring-indigo-800 ml-4 sm:ml-8 cursor-pointer"
              key={index}
            >
              <p>{filter}</p>
            </div>
      ...
      <div className="mt-7 overflow-x-auto">
        <table className="w-full whitespace-nowrap">
          <tbody>
            <tr
              tabindex="0"
              className="focus:outline-none h-16 border border-gray-100 hover:bg-indigo-100 rounded"
            >
              <td>
                <div className="ml-5">
